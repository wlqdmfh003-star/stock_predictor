...
class SectorAnalysis:
    ...
    SECTORS = {
        ...
        "유통/소비": [
            ...
            "BGF리테일","신라면세점","호텔신라","파라다이스",
            "락앤락","다이소","롯데렌탈","SK렌터카",
        ],
        "화장품/뷰티": [
            "아모레퍼시픽","LG생활건강","코스맥스","한국콜마",
            "에이피알","APR","클리오","토니모리","잇츠한불",
            "에이블씨엔씨","애경산업","브이티","실리콘투","네오팜",
            "제이준코스메틱","스킨푸드","더마펌","코스메카코리아",
            "씨앤씨인터내셔널","마녀공장","연우","퍼블리시스",
            "한국화장품","잉글우드랩","에스디생명공학","코리아나",
        ],
        "식품/음식료": [
            "CJ제일제당","오리온","농심","롯데칠성","하이트진로",
            "무학","오뚜기","동원F&B","대상","빙그레","해태제과",
            "롯데웰푸드","풀무원","크라운해태","동서","삼양식품",
            "매일유업","남양유업","파리크라상","SPC삼립","롯데푸드",
            "동원산업","사조대림","사조씨푸드","한성기업","CJ푸드빌",
        ],
        "항공": [
    ...
    YF_INDUSTRY_MAP = {
        ...
        "Grocery Stores":                     "식품/음식료",
        "Discount Stores":                    "유통/소비",
        "Apparel Retail":                     "화장품/뷰티",
        "Apparel Manufacturing":              "화장품/뷰티",
        "Packaged Foods":                     "식품/음식료",
        "Beverages—Brewers":                  "식품/음식료",
        "Beverages—Non-Alcoholic":            "식품/음식료",
        "Lodging":                            "유통/소비",
        "Travel Services":                    "유통/소비",
        "Airlines":                           "항공",
        "Personal Care Products":             "화장품/뷰티",
