...
class SectorAnalysis:
    ...
    SECTORS = {
        "반도체": [
            ...
            "어보브반도체","동운아나텍","에이디테크놀로지","하이딥","씨아이에스",
            "가온칩스","알파홀딩스","텔레칩스","코아시아","제주반도체",
        ],
        "2차전지": [
        ...
        "IT/플랫폼": [
            ...
            # ★ 게임/IT 추가
            "넷마블","데브시스터즈","넷게임즈","게임빌","조이시티",
            "웹젠","스마일게이트","카카오엔터프라이즈","두나무","빗썸",
            "업비트","토스","비바리퍼블리카","쏘카","야놀자",
        ],
        "방산": [
